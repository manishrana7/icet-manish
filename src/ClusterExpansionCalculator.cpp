                                                       ...
                                                       const double fractionalPositionTolerance)
{
    ...
    {
        Vector3d position = _supercell->getPositions().row(i);
        Vector3d offset = _clusterSpace.getPrimitiveStructure().findLatticeSiteByPosition(position, fractionalPositionTolerance).unitcellOffset();
