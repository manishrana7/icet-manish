...
class Structure
{
  public:
    ...
    /// Returns the position of a site in Cartesian coordinates.
    ...
    /// Returns LatticeNeighbor object that matches the given position.
    LatticeNeighbor findLatticeNeighborByPosition(const Vector3d &) const;

    /// Returns list of LatticeNeighbor objects that matche a given list of positions.
