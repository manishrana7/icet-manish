...
std::tuple<std::vector<int>, std::vector<double>, std::vector<int>> Cluster::getNumberOfAllowedComponentsForEachSitenimumStateBruteForce()
{
...
void Cluster::validateSorting()
{
    ...
    auto minBruteForce = getNumberOfAllowedComponentsForEachSitenimumStateBruteForce();
