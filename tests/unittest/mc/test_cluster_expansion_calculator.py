...
# class TestCECalculatorTernary(unittest.TestCase):
#     """
#     Test cluster expansion calculator for ternary systems.
#     """

#     def __init__(self, *args, **kwargs):
#         super(TestCECalculatorTernary, self).__init__(*args, **kwargs)
